...
function solve(compasses, gears, tablets) {
    // Step 1: Calculate distinct sets
    var distinctSets = Math.min(compasses, gears, tablets);
  
    // Step 2: Calculate sum of squared amounts
    var sumOfSquares = Math.pow(compasses, 2) + Math.pow(gears, 2) + Math.pow(tablets, 2);
  
    // Calculate total score
    var totalScore = (distinctSets * 7) + sumOfSquares;
